...
utils.mapkey('n', '<leader>pbrde', function()
    utils.setup_cmake('-v --build-type Debug --fetch-dependencies' .. vim.fn.input('Dependencies to remove: '))
end)
utils.mapkey('n', '<leader>pbrre', function()
    utils.setup_cmake('-v --build-type Release --fetch-dependencies' .. vim.fn.input('Dependencies to remove: '))
end)
utils.mapkey('n', '<leader>pbrdi', function()
    utils.setup_cmake('-v --build-type Dist --fetch-dependencies' .. vim.fn.input('Dependencies to remove: '))
end)
